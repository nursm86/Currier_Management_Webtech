    ...
    <body>
            <table>
                <tr>
                    ...
                    <td bgcolor = "lightgreen"><a href = "employee_home.php">Dashboard</a></td>
                    <td><a href = "view_customers.php">View Customers</a></td>
            ...
            Welcome <?php echo $_COOKIE["Loggedinuser"]; ?>(Employee)
    </body>
</html>