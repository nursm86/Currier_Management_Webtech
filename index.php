...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" align="center">
                    <p class="title-index">Online<br>Courier Service</p>
        ...
        <div class="container text-center">
            ...
            <div class="row text-center">
                <div class="col-md-4 services">
                    <img src="system_images/booking.png" class="service-img">
                    <h4>Home Delivery</h4>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 about-us">
                 ...
                 <div class="col-md-6">
                     <img src="system_images/abou-us.png" class="img_about-us">
                 </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 testimonials">
                    ...
                    <img src="system_images/ronaldo.jpg" alt="">
                    <p class="user-review"><b>Ronaldo</b><br>King at UCL</p>
                </div>
                <div class="col-md-4 testimonials">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis quibusdam eum possimus facilis? Cumque, eveniet.</p>
                    <img src="system_images/messi.jpg" alt="">
                    <p class="user-review"><b>Messi</b><br>Superstar at Barcelona</p>
                </div>
                <div class="col-md-4 testimonials">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis quibusdam eum possimus facilis? Cumque, eveniet.</p>
                    <img src="system_images/neymar.jpg" alt="">
    ...
    <section id="footer">
        ...
        <div class="container">
            ...
            <hr>
            <p class="copyright">Designed by Nur, Emon & Nayeem</p>
        </div>
    </section>
</body>
</html>